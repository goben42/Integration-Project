...
test1 = False
#the while not in this next line is used to make make sure that the user provides the correct input it tests whether a integer has been passed and if it hasnt it sends an error message
while not test1:
    try:
...
Question_2_Logic = input(
            "If im facing right and i turn 270 degrees to the right then another 90 to the left, which way am I facing now \n A. forward \n B. back \n C. right \n D. left")
...
while test1:
    try:
        Question_7_Floor_Division = int(input("If there are are 198 slices of pizza and there are 8 slices in a pizza, How many pizzas are there? \n A.24 \n B.19 \n C.26 \n D.20"))
        test1 = False
    except:
        print("Invalid Input")
...
# for in range just repeats the print statement 5 times
    ...
    print("Thats unfortunate you could have won the reward of 1 million dollars")
